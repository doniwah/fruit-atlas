...
// Test with green mango features
function test(hue, circularity, aspectRatio) {
  ...
  const clusterResults = runDBSCAN(normalized, 0.3, 4, weights);
  ...
  console.log(`Input: Hue=${hue}, Circ=${circularity}, Aspect=${aspectRatio}`);
...
test(86, 0.76, 1.34); // typical green mango features
test(86, 0.90, 1.40); // mathematically calculated circle-ish oval mango
test(12, 0.92, 1.02); // typical apple features
test(42, 0.76, 1.34); // typical db mango features
